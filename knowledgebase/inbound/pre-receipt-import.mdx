...
<Tip>**Template:** <a href="/images/templates/standard_pre_receipt_import_template.csv" download>standard_pre_receipt_import_template.csv</a> — download it, fill in your data, and upload it via SFTP.</Tip>
