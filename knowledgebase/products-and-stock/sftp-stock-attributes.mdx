...
<Tip>**Template:** <a href="/images/templates/standard_stock_attributes_update_import_template.csv" download>standard_stock_attributes_update_import_template.csv</a> — download it, fill in your data, and upload it via SFTP.</Tip>
